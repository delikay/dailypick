        ...
        >
            ...
            <div className="relative z-[1] flex h-full flex-col">
                ...
                <div className="mt-6 flex items-start gap-4">
                    ...
                    <div
                        className={`flex h-28 w-20 flex-shrink-0 items-center justify-center rounded-[1.15rem] border border-border/70 bg-surface/85 text-primary ${movie.poster ? 'hidden' : 'flex'}`}
                    >
